...
function App() {
  ...
  const playSong = async (list, idx) => {
    ...
    // Hide mini player if changing back to regular audio
  ...
  const handleAudioError = async () => {
      ...
      const toastId = toast.loading("Audio Failed. Finding Official Video...");
      try {
          ...
          if (ytResults.length > 0) {
              ...
              if (currentIndex >= 0 && currentIndex < newQueue.length) {
                  ...
                  // Auto-show the mini player so they can see the video that replaced the audio
                  setTimeout(() => setShowMiniPlayer(true), 500);
                  toast.success("Playing Official Video via YouTube", { id: toastId });
              }
    ...
    <div className="app-layout">
        ...
        <style>{`
          ...
          @media (max-width: 768px) { 
              ...
              .yt-mini-wrapper { width: 250px; height: 140px; right: 10px; bottom: 100px; }
          }
